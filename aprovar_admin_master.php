...
<?php 
	...
	$consulta = "SELECT * FROM alunos where niveis_acesso_id=1 && nivel_especial=0"; 
  ...
  <div class="container">
    ...
    <div class="container theme-showcase" role="main">      
      <div class="page-header">
        <h1>Aprovar para Administrador Master</h1>
		</div>
      <div class="row">
        <div class="col-md-12">
          <table class="table">
            ...
            <tbody>
			    ...
			    while($linhas = $con-> fetch_array()){ 
					echo "<tr>";
						...
						?>
						<td> 
						<a href='btn_aprovar_admin_master.php?id=<?php echo $linhas['id']; ?>'><button type='button' class='btn btn-sm btn-primary'>APROVAR</button></a>
