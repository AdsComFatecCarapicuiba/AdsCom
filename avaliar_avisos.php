<?php
	...
	if ($_SESSION['nivel_especial'] == "1"){
		$result_recado_bd = "SELECT * FROM recados where analise_adm=0  ORDER BY urgente DESC";
		...
		$consulta = "select * from recados inner join alunos on alunos.id = recados.id_aluno where recados.analise_adm=0 and alunos.periodo='$periodo' and alunos.ciclo='$ciclo'";
			    ...
			    while($linhas = $con-> fetch_array()){ 
					...
					//	echo "<td>".$linhas['periodo']."</td>";
						switch ($linhas['classificacao']){
							case 1: echo "<td>Calendário</td>";break;
							case 2: echo "<td>Estágio</td>";break;
							case 3: echo "<td>Atrasos/Ausência</td>";break;
							case 4: echo "<td>Trabalhos</td>";break;
							case 5: echo "<td>Monitoria</td>";break;
							case 6: echo "<td>Materiais</td>";break;	
						}
						if ($linhas['urgente'] == 1){
							echo "<td>SIM</td>";
